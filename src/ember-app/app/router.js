...
Router.map(function () {
  ...
  this.route('i-i-s-prilozhenie-40-справ-родит-e',
  { path: 'i-i-s-prilozhenie-40-справ-родит-e/:id' });
  this.route('i-i-s-prilozhenie-40-справ-родит-e.new',
  { path: 'i-i-s-prilozhenie-40-справ-родит-e/new' });
